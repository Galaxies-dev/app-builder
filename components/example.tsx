  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        />
        <TouchableOpacity onPress={() => setShowNewNote(true)} style={styles.newNoteButton}>
          ...
          {notes.map((note) => (
            <View key={note.id} style={styles.noteCard}>
              ...
              <Text style={styles.noteMeta}>
                by {note.authorId} • {formatTime(note.timestamp)}
              </Text>
            </View>
          ))}
        </View>
      ...
      {showNewNote && (
        <Modal onClose={() => setShowNewNote(false)}>
          <NewNoteForm authorId={currentUsername} onSubmit={() => setShowNewNote(false)} />
        </Modal>
      )}
    </View>
  );
